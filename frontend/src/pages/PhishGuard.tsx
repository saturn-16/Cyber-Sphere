...
function ResultCard({ result }: { result: PhishScanResult }) {
  ...
  return (
    ...
    >
      ...
      {/* AI Analysis */}
      {result.aiAnalysis && (
        <div className="p-4 mt-2 rounded-lg bg-cyber-violet/10 border border-cyber-violet/30">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-2 h-2 rounded-full bg-cyber-violet animate-pulse" />
            <div className="text-xs font-mono text-cyber-violet tracking-widest uppercase">Advanced AI Analysis</div>
          </div>
          <div className="text-sm text-cyber-text/90 leading-relaxed font-mono">
            {result.aiAnalysis}
          </div>
        </div>
      )}
